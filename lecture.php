              ...
              <div class="row-col">
                <div class="col-md-8 col-md-push-2">
                  <div class="lesson_header">
                    <h5><a href="#">Matrices : Introduction to it</a></h5>
        ...
        <div class="course_curriculum_section opened">
          <div class="curriculum_section_item opened">
            <div class="curriculum_section_item_info">
              <span> Section 1</span>
              <h3>Section 1: Introduction to Unreal engine 4</h3>
            </div>
          </div>
    ...
    <div class="course_lesson_main_content">
        ...
        <div class="row-col">
          <div class="col-md-8 col-md-push-2">
            <div class="course_lesson_title">
              <h3>Section 2: Middle Engine checking , Lecture 1</h3>
              <h2>Engine Target Audience</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="course_lesson_inner_content_main_info">
        <div class="container_inner">
          <div class="row-col">
            <div class="col-md-8 col-md-push-2">
              <p>Helloection 2: Middle Engine checking , Lecture 1 ection 2: Middle Engine checking ,
                Lecture 1 ection 2: Middle Engine checking , Lecture 1</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="course_lessons_navigation_o_O_bott completed_lesson">
    <div class="course_lessons_navigation_one_side left_side">
      <a href="#">
        ...
        <span class="section_prev_info_text">Section 1: Introduction to Unreal engine 4, Quiz 3</span>
      </a>
    </div>
