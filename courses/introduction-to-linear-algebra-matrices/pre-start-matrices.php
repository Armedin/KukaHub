<?php
 ...
 <html>
   ...
   <?php getHeader("Before studying matrices | KukaHub"); ?>
   </head>
 <body class="course_learning_page">
              ...
              <div class="row-col">
                <div class="col-md-8 col-md-push-2">
                  <div class="lesson_header">
                    <h5><a href="#">Before you start learning Matrices</a></h5>
  ...
  <div class="course_lessons_navigation_o_O_bott completed_lesson">
    ...
    <div class="course_lessons_navigation_one_side right_side">
      <a href="definition-of-a-matrix.php">
        <span class="section_prev_info_text">Section 1: Definition of a matrix, Lecture 1.1</span>
