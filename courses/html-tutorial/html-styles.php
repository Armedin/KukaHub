...
<?php
   include_adsense();
   include_script_tag();
   getHeader("HTML Styles | Kuka Academy");
?>
   <link rel="stylesheet"
        ...
        <div class="row-col">
          <div class="col-md-8 col-md-push-2">
            <div class="course_lesson_title">
              <h3>Section 1: HTML Tutorial, Lecture 1.3</h3>
              <h2>HTML Styles</h2>
            </div>
          </div>
        </div>
...
&lt;p id="text"&gt;Paragraph&lt;/p&gt;
              ...
              <div class="lesson_paragraph_20_margin">
                The <code>id</code> attribute is used to specify a unique name or identifier for an HTML element.
                This makes it easier for the CSS or JavaScript to access the the element with the specific id value and
