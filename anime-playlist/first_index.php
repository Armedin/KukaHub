...
<div  id= "landlord"  style= "left:5px;bottom:0px;" >
  ...
  <div  class= "live_ico_box" >
    ...
    <div  class= "live_ico_item type_talk"  id= "showTalkBtn" ></div >
      ...
      <div  class= "live_ico_item type_toxic"  id= "chingChongBtn" ></div>
        ...
        <div class="music_interface_song_title_details">
          <div class="curr_playing_song_name">
            <span class="song_picture">
              <img class="song_image" src="images/default_music_image.png">
            </span>
            <span class="song_details">
              <span class="song_title">NaN</span>
              <span class="song_japanese_title song_jap_title">Nan</span>
            </span>
          </div>
        </div>
      </div>
