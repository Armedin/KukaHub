class Lyrics {
    ...
    synchronize() {
      //n[0] is causing troubles --> Being 0 when it should be 85 smh It is nor reading its offset n[0].offsetTop=0
        ...
        if (this.lineElements.forEach(i => {
            ...
            let e = (n[n.length - 1].offsetTop + n[n.length - 1].offsetHeight);
            this.scrollTop = e - this.ps.clientHeight / 2;
    ...
    scroll() {
        ...
        let e = (this.scrollTop - this.ps.scrollTop) * this.scrollerIntervalStep / this.scrollerTimer;
        this.ps.scrollTop += e, this.scrollerTimer -= this.scrollerIntervalStep
    }
    decodeTimeStamp(e) {
